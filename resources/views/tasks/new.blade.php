<form id="task-form" autocomplete="off">
        ...
        <button hx-indicator="#spinner" type="button" hx-post="{{ route('tasks.store') }}" hx-target='#task-list' hx-swap='afterbegin'>Add Task <span id='spinner' class="htmx-indicator">⏳</span></button>
    </form>
<script>
